...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task7()
        {
            IEnumerable<object> result = Emps
                .GroupBy(e => e.Job)
                .Select(group => new
                    { Praca = group.Key, LiczbaPracownikow = group.Count() });
            return result;
        }
        #endregion
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = 
                from emp in Emps
                group emp by emp.Deptno into empByDeptno
                join dept in Depts on empByDeptno.Key equals dept.Deptno
                where empByDeptno.Count() > 1
                select new {name = dept.Dname.ToUpper(), numOfEmployees = empByDeptno.Count()};
            return result;
        }
        #endregion
        ...
        {
            IEnumerable<Emp> result = Emps.GetEmpsWithSubordinatesInOrder();
            return result;
        }
        #endregion
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .Where(d => 
                    Emps.Count(e => e.Deptno == d.Deptno) == 5 
    ...
    {
        public static IEnumerable<Emp> GetEmpsWithSubordinatesInOrder(this IEnumerable<Emp> emps)
        {
            var result = 
                emps
                .Where(e => emps
                        //sprawdzenie czy jakiś pracownik występuje jako menager innego pracownika
                    .Any(e2 => e2.Mgr == e)
                )
                .OrderBy(e => e.Ename)
